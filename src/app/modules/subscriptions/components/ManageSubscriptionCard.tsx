                ...
                <div className='row g-6 g-xl-10'>
                    ...
                    <div className="col-xl-4">
                        <div className="payment-details mb-3 pb-3">
                            <h3 className='mb-4 fs-3 fw-bolder text-dark text-uppercase'>Purchased Add-ons</h3>
                        ...
                        <div className="payment-details">
                            <h3 className='mb-4 fs-3 fw-bolder text-dark text-uppercase'>Available Add-ons</h3>
                            <div className="payment-details-breakup">
                                <div className='d-flex align-items-center justify-content-between mb-6'>
                                    <span className='fw-normal text-dark'>Addon 2</span>
                                    <Link to='/products/prod_NbuC1BUyYCmUV2/addons' className='text-primary'>
                                        Purchase
                                    </Link>
                                </div>
                                <div className='d-flex align-items-center justify-content-between mb-6'>
