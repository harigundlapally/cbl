...
const PaymentDetails:FC<Props> = ({ type }) => {
    ...
    return (
        <div className='d-flex flex-column w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2 onboarding-form bg-white p-20 text-center'>
            <div className='mb-8'>
